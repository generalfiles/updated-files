...
var url = "https://bitexchanger.live/";
var checking = false;
var stop = false;
...
function bit_make_exchange(id) {
	...
	bit_check_payment(id);
}


function bit_accepted_offer(id) {
	/*
	var data_url = url + "requests/bit_accepted_offer.php?id="+id;
	$.ajax({
		type: "GET",
		url: data_url,
		dataType: "html",
	...
	*/
	var data_url = url + "requests/bit_make_exchange.php?id="+id+"&a=1";
	$.ajax({
		type: "GET",
		url: data_url,
		dataType: "html",
...
function bit_declined_offer(id) {
/*
	stop = true;
	var data_url = url + "requests/bit_declined_offer.php?id="+id;
	$.ajax({
		type: "GET",
		url: data_url,
		dataType: "html",
...
*/
	var data_url = url + "requests/bit_make_exchange.php?id="+id+"&d=1";
	$.ajax({
		type: "GET",
		url: data_url,
		dataType: "html",
...
function bit_check_payment(id){
	if (checking===false){
		setInterval(function(){
			if (stop===false){
				$.ajax({
					type: "GET",
					url: url + "requests/bit_make_exchange.php?id="+id,
					dataType: "html",
					success: function (data) {
						$("#bit_exchange_box").html(data);
					}
